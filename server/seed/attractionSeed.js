    ...
    const attractionsSeed = [
        {
            ...
            cityName: cityArray[0].cityName,
            city_Id: cityArray[0]._id
        },
        {
            name: 'Hollywood Sign',
            ...
            cityName: cityArray[1].cityName,
            city_Id: cityArray[1].id
        },
        {
            name: 'Golden Gate Bridge',
            image: 'https://www.fodors.com/wp-content/uploads/2018/11/10-Golden-Gate-Bridge.jpg',
            cityName: cityArray[2].cityName,
            city_Id: cityArray[2]._id
        }
    ]
